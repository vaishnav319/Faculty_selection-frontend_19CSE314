...
import { getHrs } from "../../../../Application/Actions/data.action";
const HrTable = ({ getHrs, data: { Hrs } }) => {
        ...
        <Table sx={{ minWidth: 650 }} aria-label="simple table">
          <TableHead>
            <TableRow>
              ...
              <TableCell align="right">Remove Hr</TableCell>
            </TableRow>
          </TableHead>
          <TableBody>
            {hrData &&
...
HrTable.propTypes = {
  getHrs: PropTypes.func.isRequired,
